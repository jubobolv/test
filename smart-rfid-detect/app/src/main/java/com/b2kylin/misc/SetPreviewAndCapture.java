...
public class SetPreviewAndCapture {
    ...
    public SetPreviewAndCapture(CameraDevice cameraDevice, SurfaceHolder surfaceHolder, ImageReader imageReader, Handler handler, Activity activity, Size size) {
    ...
    public SetPreviewAndCapture(CameraDevice cameraDevice, SurfaceTexture texture, ImageReader imageReader, Handler handler, Activity activity, Size size) {
        this.cameraDevice = cameraDevice;
        this.surfaceHolder = surfaceHolder;
        this.imageReader = imageReader;
        this.handler = handler;
    ...
    public void startPreview() {
        try {
            ...
            //创建相机的会话Session
            cameraDevice.createCaptureSession(Arrays.asList(surface, imageReader.getSurface()), stateCallback, null);
